...
export const CartOrderSummary = (props) => {
  ...
  return (
    <Stack spacing="8" borderWidth="1px" rounded="lg" padding="8" width="full">
      ...
      <Button colorScheme="red" size="lg" fontSize="md" rightIcon={<FaArrowRight />} onClick={handleCheckout} _focusVisible={{border:"0px solid red"}} focusBorderColor={mode('red.500', 'red.200')} _hover={{background:"red",border:"1px solid red"}} >
        Checkout
      </Button>
    </Stack>
  )
