        ...
        <Box className="homePage" >
            ...
            <Box className="home_text">
                <Box className="home_text_img" >
                    ...
                    <Text as='u' style={{ marginTop: "10px" }} ><Link to={"/#"} >Find a Store</Link></Text>
                </Box>
                <Box style={{ textAlignLast: "left" }} >
                    <Text>
                        Free Shipping for Rewards or Orders $75+</Text>
                    <Text as='u'><Link to={"/login"}>Sign In / Join Now</Link></Text>
                </Box>
            </Box>
            ...
            <Stack spacing={5} >
                ...
                <Text as='u' ><Link style={{ fontSize: "large", cursor: "pointer" }} to={"/#"} >SHOP CONVERSE</Link></Text>
            </Stack>
            ...
            <Box className="off_Home" >
                ...
                <Box className="off_Home_link" >
                    <Box className="off_Home_li">
                        <Text as='u' ><Link to={"/#"}>SHOP THE SALE</Link></Text>
                    </Box>
                    <Box className="off_Home_li" >
                        <Text as='u'><Link to={"/#"}>SHOP ALL NIKE</Link></Text>
                    </Box>
                </Box>
            </Box>
            ...
            <Box className="offer_home_l">
                <Box className="offer_home">
                    ...
                    <Box className="offer_hom" >
                        <Text as='u' >
                            <Link to={"/#"} style={{ fontSize: "large" }} >SHOES NOW</Link>
                        </Text>
                    </Box>
                </Box>
            </Box>
            ...
            <Box className="style_home" >
                <Box className="style_home_section" >
                    ...
                    <Text as='u' ><Link to={"/#"} style={{ fontWeight: "bold" }}>SHOP NIKE WAFFLE DEBUT</Link></Text>
                </Box>
                <Box className="style_home_section" style={{ marginLeft: "20px" }} >
                    ...
                    <Text as='u' ><Link to={"/#"} style={{ fontWeight: "bold" }} >SHOP CROCS</Link></Text>
                </Box>
            </Box>


            <Box className="footer_img" >
                <Image src="https://www.famousfootwear.com/-/media/project/tenant/famous-footwear/famous-footwear/homepage/2023/spring/1-story/wk3_021223_hp_left_loafers.jpg" alt="pic" width="50%" />

                <Image src="https://www.famousfootwear.com/-/media/project/tenant/famous-footwear/famous-footwear/homepage/2023/spring/1-story/wk3_021223_hp_right_loafers.jpg" alt="pic" width="50%" />
            </Box><br />
            <Text>The perfect transition shoe from the early spring chill to late spring sunshine.</Text><br />
            <Text as='u' ><Link to={"/#"} style={{ fontWeight: "bold" }}>SHOP SPRING LOAFERS</Link></Text>
            ...
            <Box className="gotta_brands" >
                <Heading size="md" fontSize="2xl" >Gotta-Have Brands</Heading>
                <Box className="gotta_brands_logo" >
                    <Box className="gotta_brands_box" style={{ marginLeft: "0px" }}>
                        <Image src="https://www.famousfootwear.com/-/media/project/tenant/famous-footwear/famous-footwear/tests/hp-bts-redesign/brands/hp_logo_nike.png" alt="logo" />
                    </Box>
                    <Box className="gotta_brands_box" >
                        <Image src="https://www.famousfootwear.com/-/media/project/tenant/famous-footwear/famous-footwear/tests/hp-bts-redesign/brands/hp_logo_converse.png" alt="logo" />
                    </Box>
                    <Box className="gotta_brands_box" >
                        <Image src="https://www.famousfootwear.com/-/media/project/tenant/famous-footwear/famous-footwear/homepage/2023/spring/logos/hp_logo_vans.jpg" alt="logo" />
                    </Box>
                    <Box className="gotta_brands_box" >
                        <Image src="https://www.famousfootwear.com/-/media/project/tenant/famous-footwear/famous-footwear/homepage/2022/fall/logos/hp_logo_heydude.png" alt="logo" />
                    </Box>
                    <Box className="gotta_brands_box" >
                        <Image src="https://www.famousfootwear.com/-/media/project/tenant/famous-footwear/famous-footwear/homepage/2022/fall/logos/hp_logo_birkenstock.png" alt="logo" />
                    </Box>
                    <Box className="gotta_brands_box" >
                        <Image src="https://www.famousfootwear.com/-/media/project/tenant/famous-footwear/famous-footwear/homepage/2023/spring/logos/hp_logo_crocs.jpg" alt="logo" />
                    </Box>
            ...
            <Box className="red_banner" >
                <Box className="red_banner_pic" >
                    <Image src="https://www.famousfootwear.com/-/media/project/tenant/famous-footwear/famous-footwear/homepage/2022/back-to-school/rewards-hp-banner/rewards_logo.png" alt="redBanner" width="50%" marginLeft='40px' />
                </Box>
                <Box className="red_banner_pic" >
                    <Heading size='md' color='#fff' marginRight='140px'>REWARDS YOU'LL LOVE</Heading><br /><br />
                    <Image src="https://www.famousfootwear.com/-/media/project/tenant/famous-footwear/famous-footwear/homepage/2022/back-to-school/rewards-hp-banner/rewards_benefits.png" alt="redBanner" />
                </Box>
                <Box className="red_banner_pic">
                    <Button id="butt" >JOIN NOW</Button>
                    <Text as='u' marginLeft="20px" color='#fff' ><Link to={"/signup"} >SIGN IN</Link></Text>
                </Box>
            </Box>
            ...
            <Text as='u' ><Heading size='md' marginBottom='50px'><Link to={"/#"} >GET MORE FRESH INSPO</Link></Heading></Text>
            ...
            <Box className="text_home">
                ...
                <Text fontSize='4xl' marginTop='70px' >Find Your Next Pair of Shoes at Famous Footwear</Text>
            </Box>
