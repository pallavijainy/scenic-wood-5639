    ...
    <>
      ...
      <Box w="100%" p="4">
        ...
        <Flex alignContent={"space-between"} gap="50%">
          <Flex>
            <Image
              ...
              alignItems={"Center"}
            />
            <Link textDecoration={"underline"} colorScheme="red">
              Find a Store
            </Link>
          </Flex>
          <Box>
            <Text textAlign={"right"}>
              Free Shipping for Rewards or Orders $75+
            </Text>
          </Box>
        </Flex>
        ...
        >
            ...
            <Flex gap={4}>
              ...
              <Center>
                <Text color={"gray"} textAlign="left">
                  Need Help?<Link>Email us</Link> or call us at 888-869-1053Cart
                  Number: 999909990
                </Text>
              </Center>
            </Flex>
          ...
          <GridItem>
            <Flex gap={4}>
              ...
              <Center>
                <Text color={"gray"} textAlign="left">
                  Please note: We cannot split orders for shipment to multiple
                  addresses.
                </Text>
              </Center>
            </Flex>
        ...
        >
          <GridItem>
            <Text textAlign={"left"}>
              Sign up for special offers & trend updates1
            </Text>
          </GridItem>
        ...
        >
          <Flex textAlign={"left"}>
            <Box m="2">
              <FaBoxOpen mt={1} size="40px" color="#D50032" />
            </Box>
            <Flex direction={"column"}>
              <Text>Free Shipping for Members</Text>
              <Text color={"gray"}>
                Plus, return your purchase to any store, at any time.
              </Text>
            </Flex>
          ...
          <Flex textAlign={"left"}>
            <Box m="2">
              <FaGift mt={1} size="40px" color="#D50032" />
            </Box>
            <Flex direction={"column"}>
          ...
          <Flex textAlign={"left"}>
            <Box m="2">
              <ImStopwatch mt={1} size="40px" color="#D50032" />
            </Box>
            <Flex direction={"column"}>
              <Text>Famously Fast Pickup</Text>
              <Text color={"gray"}>
                Order online, pick up in store or at the curb. Plus, members
                earn a bonus reward!
              </Text>
            </Flex>
            <Divider orientation="vertical" ml={2} mr={2} />
          ...
          <Flex textAlign={"left"}>
            <Box m="2">
              <FaMobileAlt mt={1} size="40px" color="#D50032" />
            </Box>
            <Flex direction={"column"}>
              <Text>Pay Your Way</Text>
              <Text color={"gray"}>
                Enjoy Zip, the Famously YOU Rewards® Credit Card and more.
              </Text>
            </Flex>
          </Flex>
        </Grid>
